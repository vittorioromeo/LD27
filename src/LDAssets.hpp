...
namespace ld
{
	class LDAssets
	{
		...
		public:
			...
			ssvs::Tileset tilesetChar{ssvj::fromFile("Data/Tilesets/tilesetChar.json").as<ssvs::Tileset>()};
			ssvs::Tileset tilesetWorld{ssvj::fromFile("Data/Tilesets/tilesetWorld.json").as<ssvs::Tileset>()};
